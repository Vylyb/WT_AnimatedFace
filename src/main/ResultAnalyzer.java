...
//								System.out.println();
	...
	private static void printResults() {
		...
		try {
			...
			int maxCols=4;
			int table[][]=new int[rowNames.length+1][maxCols];
			...
			for(String key:keys)
			{
				...
				{
					table[0][faceOnly]++;
					System.out.println("Face Only => "+table[0][faceOnly]);
					if(isMaximumOnEmph(result,result.getFaceEmph()))
					{
						table[maxOnFace][faceOnly]++;
						System.out.println("\t=> table[maxOnFace][faceOnly] = "+table[maxOnFace][faceOnly]);
					}
					else if(isMaximumAfterEmph(result,result.getFaceEmph()))
					{
						table[maxAfterFace][faceOnly]++;
						System.out.println("\t=> table[maxAfterFace][faceOnly] = "+table[maxAfterFace][faceOnly]);
					}
					else if(isMaximumBeforeEmph(result,result.getFaceEmph()))
					{
						table[maxBeforeFace][faceOnly]++;
						System.out.println("\t=> table[maxBeforeFace][faceOnly] = "+table[maxBeforeFace][faceOnly]);
					}
				}
				else if(result.isVoiceOnly())
				{
					table[0][voiceOnly]++;
					System.out.println("Voice Only => "+table[0][voiceOnly]);
					if(isMaximumOnEmph(result,result.getVoiceEmph()))
					{
						table[maxOnVoice][voiceOnly]++;
						System.out.println("\t=> table[maxOnVoice][voiceOnly] = "+table[maxOnVoice][voiceOnly]);
					}
					else if(isMaximumAfterEmph(result,result.getVoiceEmph()))
					{
						table[maxAfterVoice][voiceOnly]++;
						System.out.println("\t=> table[maxAfterVoice][voiceOnly] = "+table[maxAfterVoice][voiceOnly]);
					}
					else if(isMaximumBeforeEmph(result,result.getVoiceEmph()))
					{
						table[maxBeforeVoice][voiceOnly]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceOnly] = "+table[maxBeforeVoice][voiceOnly]);
					}
				}
				else if(result.isVoiceAndFaceSeparated())
				{
					table[0][voiceAndFaceSeparated]++;
					System.out.println("Voice And Face Separated => "+table[0][voiceAndFaceSeparated]);
					if(isMaximumOnEmph(result,result.getVoiceEmph()))
					{
						table[maxOnVoice][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxOnVoice][voiceAndFaceSeparated] = "+table[maxOnVoice][voiceAndFaceSeparated]);
					}
					else if(isMaximumAfterEmph(result,result.getVoiceEmph()))
					{
						table[maxAfterVoice][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxAfterVoice][voiceAndFaceSeparated] = "+table[maxAfterVoice][voiceAndFaceSeparated]);
					}
					else if(isMaximumBeforeEmph(result,result.getVoiceEmph()))
					{
						table[maxBeforeVoice][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceAndFaceSeparated] = "+table[maxBeforeVoice][voiceAndFaceSeparated]);
					}

					if(isMaximumOnEmph(result,result.getFaceEmph()))
					{
						table[maxOnFace][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxOnFace][voiceAndFaceSeparated] = "+table[maxOnFace][voiceAndFaceSeparated]);
					}
					else if(isMaximumAfterEmph(result,result.getFaceEmph()))
					{
						table[maxAfterFace][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxAfterFace][voiceAndFaceSeparated] = "+table[maxAfterFace][voiceAndFaceSeparated]);
					}
					else if(isMaximumBeforeEmph(result,result.getFaceEmph()))
					{
						table[maxBeforeFace][voiceAndFaceSeparated]++;
						System.out.println("\t=> table[maxBeforeFace][voiceAndFaceSeparated] = "+table[maxBeforeFace][voiceAndFaceSeparated]);
					}
				}
				else if(result.isVoiceAndFace())
				{
					table[0][voiceAndFace]++;
					System.out.println("Voice And Face => "+table[0][voiceAndFace]);
					if(isMaximumOnEmph(result,result.getVoiceEmph()))
					{
						table[maxOnVoice][voiceAndFace]++;
						System.out.println("\t=> table[maxOnVoice][voiceAndFace] = "+table[maxOnVoice][voiceAndFace]);
					}
					else if(isMaximumAfterEmph(result,result.getVoiceEmph()))
					{
						table[maxAfterVoice][voiceAndFace]++;
						System.out.println("\t=> table[maxAfterVoice][voiceAndFace] = "+table[maxAfterVoice][voiceAndFace]);
					}
					else if(isMaximumBeforeEmph(result,result.getVoiceEmph()))
					{
						table[maxBeforeVoice][voiceAndFace]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceAndFace] = "+table[maxBeforeVoice][voiceAndFace]);
					}

					if(isMaximumOnEmph(result,result.getFaceEmph()))
					{
						table[maxOnFace][voiceAndFace]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceOnly] = "+table[maxBeforeVoice][voiceOnly]);
					}
					else if(isMaximumAfterEmph(result,result.getFaceEmph()))
					{
						table[maxAfterFace][voiceAndFace]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceOnly] = "+table[maxBeforeVoice][voiceOnly]);
					}
					else if(isMaximumBeforeEmph(result,result.getFaceEmph()))
					{
						table[maxBeforeFace][voiceAndFace]++;
						System.out.println("\t=> table[maxBeforeVoice][voiceOnly] = "+table[maxBeforeVoice][voiceOnly]);
					}
				}
			}
			...
			writer.write("<h4>Statistiken</h4>\n" +
			...
			for(int row=1;row<table.length;row++)
			{
				...
				for(int col=0;col<maxCols;col++)
				{
					...
					{
						content="<h5>"+round((100.0/(double)table[0][col])*(double)table[row][col],100)+
								"%</h5>"+table[row][col];
					}
